...
app.get("/api/testa", checkPermission("serviceA"), function (req, res, next){

    return serviceA(req, res);
});

app.get("/api/testb", checkPermission("serviceB"), function (req, res, next){

    return serviceB(req, res);
});

app.get("/api/testc", checkPermission("serviceC"), function (req, res, next){

    return serviceC(req, res);
});

app.get("/api/testd", checkPermission("serviceD"), function (req, res, next){

    return serviceD(req, res);
});


app.get("/api/test2a", function (req, res, next){

    if(!isServicePermit("serviceA", req.user?.id))
...
app.get("/api/test2b", function (req, res, next){

    if(!isServicePermit("serviceB", req.user?.id))
...
app.get("/api/test2c", function (req, res, next){

    if(!isServicePermit("serviceC", req.user?.id))
...
app.get("/api/test2d", function (req, res, next){

    if(!isServicePermit("serviceD", req.user?.id))
